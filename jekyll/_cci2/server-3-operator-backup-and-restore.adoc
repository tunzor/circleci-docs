...
[source,bash]
----
mc alias set my-provider <YOUR_ENDPOINT> <YOUR_ACCESS_KEY_ID> <YOUR_SECRET_ACCESS_KEY>
----
...
----
# Create user
mc admin user add my-provider <YOUR_VELERO_ACCESS_KEY_ID> <YOUR_VELERO_SECRET_ACCESS_KEY>
...
mc admin policy add my-provider velero-policy velero-policy.json

# Bind user to policy
mc admin policy set my-provider velero-policy user=<YOUR_VELERO_ACCESS_KEY_ID>
----
